...
object Constants {
    const val HUMOR_API_URL = "https://api.humorapi.com/jokes/random" +
            ...
            "&max-length=180" +
            "&exclude-tags=nsfw,dark"
    const val PAGE_WIDTH = 1920
    const val COLLAPSED_PANEL_HEIGHT = 100
    const val HEADER_HEIGHT = 100
    const val SIDE_PANEL_WIDTH = 250
    const val WHATSAPP = "http://Wa.me/7045515703"
    const val TWITTER = "https://www.twitter.com/mofeoritse"
    const val INSTAGRAM = "https://www.instagram.com/jeffietech/"
    const val LINKEDIN = "https://www.linkedin.com/in/moju-jeffrey-5b7338253"
    const val FORM_LINK = "https://formspree.io/f/mrgnbzkw"
    const val WEBSITE = "https://github.com"
    const val PORTFOLIOLINK = "http://localhost:8080/portfolio/"
    const val FONT_FAMILY = "Roboto"
    const val ABOUT_ME_TEXT = "As a full-stack developer, I bridge the gap between beautiful " +
            "front-ends and robust back-ends, weaving effectiveness and creativity into scalable" +
            " apps that empower startups and corporations across industries. I'm not just a coder; " +
            "I'm a passionate problem-solver, fueled by mastering new tech and exceeding " +
            "expectations. Let's collaborate to build something amazing - your vision, powered " +
            "by my skills."
}
object Res{
    object Icon {
        ...
        const val kobweb = "kobweb.png"
        const val kotlin = "kotlin.png"
        const val ktor = "ktor.png"
        ...
        const val orderedlist = "/ordered_list.svg"
        const val quote = "/quote.svg"
        const val strikethrough = "/strikethrough.svg"
        const val subscript = "/subscript.svg"
        const val subtitle = "/subtitle.svg"
        const val superscript = "/superscript.svg"
        const val table = "/table.svg"
        const val textfill = "/text_fill.svg"
        const val title = "/title.svg"
        const val underline = "/underline.svg"
        const val unorderedlist = "/unordered_list.svg"
